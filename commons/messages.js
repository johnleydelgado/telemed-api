export default {
  ...
  auth: {
    ...
    canNotDeleteStaff:
      "There are ongoing dictations referenced to this editor/assignee",
  ...
  mail: {
    ...
    subject: {
      verificationCode: "Travel4U verification code",
      ...
      inviteUser: "Travel4U Invitation",
    },
  },
  upload: {
  ...
  assignee: {
    ...
    hasReference:
      "Assignee has unresolved tasks. Resolve tasks or remove assignments to continue.",
  },
  template: {
    somethingWrong: "Something has wrong",
  ...
  turnAroundTime: {
    ...
    hasReference:
      "This turnaround time is currently on use. Resolve tasks or change assigned TAT to continue.",
  },
  dictation: {
    changeStatus: {
      notHaveEditorInCharge:
        "An Editor-In-charge is required to set this dictation in progress.",
      notHaveTranscriptions:
        "There's no transcription to submit. Kindly attach transcription file first.",
    },
  },
};
